...
class Speaking_page extends StatefulWidget {
  const Speaking_page({Key? key}) : super(key: key);

  @override
  State<Speaking_page> createState() => _Speaking_pageState();
}

class _Speaking_pageState extends State<Speaking_page> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
          stream: FirebaseFirestore.instance.collection('Speaking').snapshots(),
