...
class Listening_page extends StatefulWidget {
  const Listening_page({Key? key}) : super(key: key);

  @override
  State<Listening_page> createState() => _Listening_pageState();
}

class _Listening_pageState extends State<Listening_page> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
          stream: FirebaseFirestore.instance.collection('Listening').snapshots(),
